...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    TDI: Schema.Attribute.Component<'shared.seo', true> &
...
export interface ApiEventContainerEventContainer
  extends Struct.SingleTypeSchema {
  collectionName: 'event_containers';
  info: {
    singularName: 'event-container';
    pluralName: 'event-containers';
    displayName: 'Event Container';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-container.event-container'
    >;
  };
}
...
export interface ApiExchangeExchange extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    description: 'Define exchange settings';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Your site title'>;
...
export interface ApiGridCardGridCard extends Struct.SingleTypeSchema {
...
export interface ApiPaymentMethodPaymentMethod
  ...
  attributes: {
    ...
    TAGURL: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    itemId: Schema.Attribute.UID<'title'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    isActive: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    prices: Schema.Attribute.Component<'shared.prices', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    testimonialMedia: Schema.Attribute.Media<'videos'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::event-container.event-container': ApiEventContainerEventContainer;
